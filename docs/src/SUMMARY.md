...
- [Pillar 1: Standardized Data Model](./pillars/data-model/overview.md)
  ...
  - [Players & Collections](./pillars/data-model/players.md)
  - [Rating Model](./pillars/data-model/rating-model.md)
  - [Weight Model](./pillars/data-model/weight-model.md)
...
- [ADR Index](./adr/index.md)
  ...
  - [Core Data Model]()
    ...
    - [ADR-0043: Player Count Sentiment Improvements](./adr/0043-player-count-sentiment-model-improvements.md)
    - [ADR-0044: Player Entity & Collections](./adr/0044-player-entity-and-collection-data.md)
  - [API Design]()
